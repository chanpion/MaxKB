...
import {HomeOutlined, SettingOutlined, AppstoreOutlined} from '@ant-design/icons'
import {useTranslations} from 'next-intl'

/* 资源管理-应用：后端暂未提供跨工作区资源列举端点。占位页待后端实现后填充。 */
export default function ResourceApplicationPage() {
  ...
  return (
    <div>
      ...
      <Typography.Title level={4} style={{marginBottom: 16}}>资源管理 · 应用</Typography.Title>
